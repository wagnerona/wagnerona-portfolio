  ...
  return (
    <div name=' Home' className='w-full h-screen bg-slate-300'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h2 className='text-4xl sm-text-7xl py-4 max-w-[700px] font-bold text-'>I am a product designer & Full Stack Web Developer.</h2>
        <p className='text- py-2 max-w-[700px]'>The main focus relies on user experience and a passion for innovation</p>
        <div>
